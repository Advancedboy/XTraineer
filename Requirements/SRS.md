...
## 1.1. Назначение
Данный документ описывает функциональные и нефункциональные требования к мобильному приложению **Fitness Companion** — интерактивному инструменту для пользователей, занимающихся спортом.  
...
### 1.2.2. Возможности
Приложение **Fitness Companion** позволит пользователям:
...
В отличие от них, **Fitness Companion** делает акцент на простоте, персональных рекомендациях и гибкости, без сложных меню и избыточных функций.
